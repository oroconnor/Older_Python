...
def write_to_file(filename, myname, myage, major):
    ...
    outfile.write("My major is" + major + "and my age is" + str(myage) +".")
    outfile.close()
...
def name_phone(csv_filename):
    ...
    while True:
        ...
        nextphone = input("Enter a friend's phone:")
        print(nextname) 
        print(nextphone)
        namephone = [nextname, nextphone]
        csv.writer(f).writerow(namephone)
